...
public class AddNewVehicleFrame extends javax.swing.JFrame {

    public AddNewVehicleFrame() {
        initComponents();
        //setExtendedState(JFrame.MAXIMIZED_BOTH);
        //setUndecorated(true);
        anvfeeEdit.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent ke) {
                String value = anvfeeEdit.getText();
                int l = value.length();
                if (ke.getKeyChar() >= '0' && ke.getKeyChar() <= '9') {
                    anvfeeEdit.setEditable(true);
                } else {
                    anvfeeEdit.setEditable(false);
                    JOptionPane.showMessageDialog(AddNewVehicleFrame.this, "* Enter only numeric digits(0-9)");
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        anvfeeEdit.setContentType("numeric"); // NOI18N
        anvfeeEdit.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jScrollPane2.setViewportView(anvfeeEdit);
        anvfeeEdit.getAccessibleContext().setAccessibleDescription("numeric");
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                if (n > 0) {
                    ...
                    AuthorityHomeFrame ahf = new AuthorityHomeFrame();
                    ahf.setVisible(true);
                ...
                Logger.getLogger(AddNewVehicleFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewVehicleFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewVehicleFrame().setVisible(true);
            }
        });
    }
