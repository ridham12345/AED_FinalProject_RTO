...
public class CustomerHomeFrame extends javax.swing.JFrame {
  ...
  private void populateTable2() throws Exception {
    ...
    public CustomerHomeFrame(int cid, String cname) throws Exception {
        ...
        drivingname();
        vehiclename();
        userLabel.setText("Welcome " + cname);
        setResizable(false);
...
//        jPanel5.add(statusPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 874, -1));
 ...
 /*        javax.swing.GroupLayout testPanelLayout = new javax.swing.GroupLayout(testPanel);
    ...
    private void appliedBtnActionPerformed(java.awt.event.ActionEvent evt) {
...
//        testPanel.setVisible(false);
    ...
    private void initComponents() {
        ...
        userLabel.setText("Welcome Bhavik");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(userLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        CustomerTabbedPane.addTab("Apply For new Test", jPanel1);
        ...
        CustomerTabbedPane.addTab("Applied Test", jPanel2);
        ...
        CustomerTabbedPane.addTab("Upcoming Test", jPanel3);
    ...
    private void btnChangePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangePasswordActionPerformed
        try {
            ...
            if (newPassword.length() > 0) {
                ...
                int n = dao.updatePassword(cid, newPassword);
